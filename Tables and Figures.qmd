...
fiord_labels<-data.frame(label = c("Piopiotahi-Milford Sound","Te H\u101pua-Sutherland Sound",
                                   ...
                                   "Te Puaitaha-Breaksea Sound","Tamatea-Dusky Sound","Taiari-Chalky Inlet",
...
bathy_FMA<-ggplot()+
  ...
  geom_polygon(mapping = aes(y=c(-45.13,-45.15,-45.23,-45.28,-45.43,-45.50,-45.44), 
                             x=c(166.97,166.96,166.88,166.85,166.91,167.06,167.46)), fill = "yellow", alpha = 0.9)+
  #Dusky complex
  geom_polygon(mapping = aes(y=c(-45.55,-45.61,-45.73,-45.83,-45.76,-45.44), 
                             x=c(166.68,166.60,166.45,166.45,167.04,167.03)), fill = "orange", alpha = 0.9)+
  geom_sf(data = NZ_coast, alpha = 1, fill = "white")+
  geom_path(alliso200, mapping = aes(X,Y,group = L2), color = "steelblue4", alpha = 0.7, linewidth = 0.2)+
  geom_path(alliso50, mapping = aes(X,Y,group = L2), color = "grey", alpha = 0.9, linewidth = 0.2)+
...
ggsave("./figures/map_a.png", map, dpi = 700, height = 6, width = 4, units = 'in')
ggsave("./figures/map_a.svg", map, dpi = 700, height = 6, width = 4, units = 'in')
