...
NZ<-base+
  ...
  xlab("")+
  ylab("")+
  geom_rect(mapping = aes(xmin = 166, xmax = 171, ymin = -47.5, ymax = -43), fill = NA, color = "black")+
  theme_void()+
  geom_text_repel(data = dunedin, aes(x = lon, y = lat, label = label), size = 2.3, force_pull = 2, box.padding = 0.1, min.segment.length = 0, nudge_x = 2)
