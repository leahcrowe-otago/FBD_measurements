...
Model code to confirm exploratory findings that sex and pod do not influence growth parameters. Model results are available in Table S3.

\tiny

```{r, AppendixII, results='markup',echo=FALSE,comment="", warning = F}
